Pod::Spec.new do |s|
  ...
  s.version     = "20.0.0"
  s.license     = { :type => "MIT" }
  s.homepage    = "https://github.com/kmrAX/keychain-swift"
  ...
  s.source      = { :git => "https://github.com/kmrAX/keychain-swift.git", :tag => s.version }
  s.screenshots  = "https://raw.githubusercontent.com/kmrAX/keychain-swift/master/graphics/keychain-swift-demo-3.png"
